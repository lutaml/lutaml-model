...
class FiveDigitPostCode < Lutaml::Model::Type::String
  def self.cast(value)
    ...
    unless value.is_a?(::String)
      raise Lutaml::Model::ValueNotAllowedError, "Invalid value for type 'FiveDigitPostCode'"
    end
...
any other value is given, a `Lutaml::Model::ValueNotAllowedError` will be raised.
...
> # Lutaml::Model::ValueNotAllowedError: Invalid value for attribute 'name'
----
====
...
> # Lutaml::Model::ValueNotAllowedError: Invalid value for attribute 'featured_piece'
----
====
...
> # Lutaml::Model::ValueNotAllowedError: Invalid value for attribute 'color'
----
====
