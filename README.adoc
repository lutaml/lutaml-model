...
[source,ruby]
----
element = Lutaml::Model::KeyValueDataModel::KeyValueElement.new(
  "person",
  nil,  # No direct value
  [
    Lutaml::Model::KeyValueDataModel::KeyValueElement.new("name", "John Doe"),
    Lutaml::Model::KeyValueDataModel::KeyValueElement.new("age", "30")
  ]
)
----
