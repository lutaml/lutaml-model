...
It groups a set of element declarations, allowing them to be reused together. It permits only one child: `choice`.

Group only supports choice

If the attributes defined directly in group or
the nested group | multiple choices are defined, `InvalidGroupError` will be
