...
You can also define **one custom method** (`from` or `to`). But in this case, you must have to define `to: <attribute-name>` outside `with` for **default mapping**.
...
class CustomCeramic < Lutaml::Model::Serializable
  ...
  xml do
    map_element "Name", to: :name, with: { from: :name_from_xml }
...
[source,xml]
----
<CustomCeramic Size="15" Country="Spain">
...
> puts CustomCeramic.new(name: "Vase", size: 12, country: "Spain", description: "A beautiful vase", metadata: Metadata.new(category: "Glaze", identifier: 15)).to_xml
# <CustomCeramic Size="15" Country="Spain">
#   <Name>XML Masterpiece: Vase</Name>
#   <metadata>
...
> #<CustomCeramic:0x0000000104ac7240 @name="Vase", @size=12, @color="blue",>
> CustomCeramic.new(name: "Vase", size: 12, color: "blue").to_json
> #{"name"=>"Masterpiece: Vase", "color": "blue", size"=>12}
----
====
