...
Custom date and time formats can be created by inheriting from the appropriate base types and overriding the serialization methods. Here are some additional examples:
