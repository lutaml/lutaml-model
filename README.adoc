...
Note: The `type` can also be a superclass. If a class is provided, it can represent a specific type, including a superclass, allowing polymorphic behavior where subclasses of the given class are also valid.
...
Studio.new(postcode: FiveDigitPostCode.new(12345))
----
====
