...
# => raises Lutaml::Model::Validation::ValidationError
----
...
| `Validation::Registry`
| Instance-based rule registration with `register`, `all`, `for_category`, `find`

| `Validation::Profile`
| YAML composable profiles with import resolution for rule subsets
...
| Abstract base for auto-fix logic linked to specific issue codes
|===
