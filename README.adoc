...
The [`XmlNamespace`](lib/lutaml/model/xml_namespace.rb) class provides a
...
A namespace class inherits from [`Lutaml::Model::XmlNamespace`](lib/lutaml/model/xml_namespace.rb)
...
The [`element`](lib/lutaml/model/xml/mapping.rb) method is the primary way to
...
The [`root`](lib/lutaml/model/xml/mapping.rb) method is maintained as a
...
The [`mixed_content`](lib/lutaml/model/xml/mapping.rb) method explicitly enables
mixed content mode.
...
The [`documentation`](lib/lutaml/model/xml/mapping.rb) method adds
...
The [`type_name`](lib/lutaml/model/xml/mapping.rb) method sets an explicit type
...
. Namespace-level defaults via [`element_form_default`](lib/lutaml/model/xml_namespace.rb) and [`attribute_form_default`](lib/lutaml/model/xml_namespace.rb)
...
Custom [`Type::Value`](lib/lutaml/model/type/value.rb) classes can declare
their own namespace for XSD generation.

This is useful for reusable types that belong to specific namespaces.

=== Implementation

Override the `self.xsd_namespace` class method in your custom type:
...
class CustomType < Lutaml::Model::Type::Value
  def self.xsd_namespace
    'https://example.com/custom-types'
  end
...
# When generating XSD, the EmailType namespace is included:
# <xs:schema xmlns:email="https://example.com/types/email">
#   <xs:import namespace="https://example.com/types/email" />
#   ...
#   <xs:element name="email" type="email:EmailAddress"/>
# </xs:schema>
----
====
...
The [`Type::Reference`](lib/lutaml/model/type/reference.rb) type can utilize
...
The [`Lutaml::Model::Schema.to_xml`](lib/lutaml/model/schema.rb) method
...
* Models with [`element`](lib/lutaml/model/xml/mapping.rb) declared: Generate
...
* Override via [`type_name`](lib/lutaml/model/xml/mapping.rb)
...
* [`Nokogiri`](lib/lutaml/model/schema/schema_builder/nokogiri.rb): Default,
full XSD 1.0 support
* [`Oga`](lib/lutaml/model/schema/schema_builder/oga.rb): Pure Ruby, feature
complete
