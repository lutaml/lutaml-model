...
class ProcOrderedItemCollection < Lutaml::Model::Collection
  instances :items, Item
  # Order by name in descending order using a proc
...
class ComplexOrderedItemCollection < Lutaml::Model::Collection
  instances :items, Item
...
> proc_collection = ProcOrderedItemCollection.new(items_data)
> proc_collection.map(&:name)
> # ["Zebra", "Beta", "Alpha"] # Sorted by name descending

> complex_collection = ComplexOrderedItemCollection.new(items_data)
