...
Collections are used to represent a collection
of multiple models.

Typically, a collection represents an Array or a Set in information modeling and programming languages.

Models in a collection may be:

* constrained to be of a single kind

* constrained to be of multiple kinds sharing
