...
For now, group only supports choice
...
For now, choice supports (element, group, choice)*
...
klin = Klin.new(name: "Klin", degree_settings: [], description: "four", prefix: "Ben", name: "Smith")
klin.validate
# => [
