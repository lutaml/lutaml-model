...
This is only applicable if the `to: :name_of_element` or `to: :name_of_attribute` option is set.  
...
> #<CustomCeramic:0x0000000108d0e1f8
   ...
   @ordered=nil,
   @size=15>
> puts CustomCeramic.new(name: "Vase", size: 15, description: "A beautiful vase", metadata: Metadata.new(category: "Glaze", identifier: 15)).to_xml
# <CustomCeramic Size="15">
#   <Name>XML Masterpiece: Vase</Name>
# </CustomCeramic>
----
