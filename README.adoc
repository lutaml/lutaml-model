...
> #<Ceramic:0x0000000104ac7240 @type="Porcelain", @glaze="Clear",
  # @color="navy-blue",
  # @schema_location=[
  #   <Location:0x0000000104ac7240
  #     @namespace="http://example.com/ceramic",
  #     @location="http://example.com/ceramic.xsd">,
  #   <Location:0x0000000104ac7241
  #     @namespace="http://example.com/color",
  #     @location="http://example.com/color.xsd">]
  # >
> schema_loc = c.schema_location
> # [ #<Location:0x0000000104ac7240 @namespace="http://example.com/ceramic", @location="http://example.com/ceramic.xsd">,
  #   #<Location:0x0000000104ac7241 @namespace="http://example.com/color", @location="http://example.com/color.xsd"> ]
