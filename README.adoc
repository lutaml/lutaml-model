...
==== Attribute extraction at root

NOTE: This feature is for key-value data model serialization only.

The `root_mappings` option is used for nesting key-value with dynamic root name (key).
...
----
json | yaml | toml do
  root_mappings to: :name_of_attribute, root: { root_key_of_hash: :key, name_of_attribute: :value_of_hash }
end
----

The `root` is specified keyword used for setting the key and value for hash.

.Using the `root_mappings` option to extract values from a key-value data model
[example]
====
...
"NISTu1":
  root_units:
    enumerated_root_units: "power"
"NISTu2":
  root_units:
    enumerated_root_units: "energy"
----
...
class RootUnit < Lutaml::Model::Serializable
  attribute :enumerated_root_unit, :string
...
[source,ruby]
----
> UnitsDb.from_yaml(yaml)
> #<UnitsDb:0x0000000107a2cf30
  @root_unit= 
    [#<Unit:0x0000000107a2c580 
      @id="NISTu1",                          
      @root_unit=#<RootUnit:0x0000000107a27c38 @enumerated_root_units="power",
     #<Unit:0x00000001098b4cc8                              
      @id="NISTu2",                                         
      @root_unit=#<RootUnit:0x00000001098b49d0 @enumerated_root_unit="energy"]>
> UnitsDb.new(root_unit: [Unit.new(id: "NISTu1", root_unit: RootUnit.new(enumerated_root_units: "power")), Unit.new(id: "NISTu2", root_unit: RootUnit.new(enumerated_root_units: "energy"))]).to_yaml
> #"---\nNISTu1:\n root_units:\n enumerated_root_units: power\nNISTu2:\n root_units:\n enumerated_root_units: energy\n"
----
====
