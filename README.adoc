...
| YAML        | `empty`       | `nil`           | An empty string (`""`) in the model is deserialized as `nil`.
...
| JSON        | `empty`       | `nil`           | An empty string (`""`) in the model is serialized as `nil`.
...
| TOML        | `empty`       | `nil`           | An empty string (`""`) in the model is treated as `nil` for TOML serialization.
