...
REXML::
(optional)
Pure Ruby XML parser included in Ruby's standard library.
Does not require external gems or native extensions.
Part of the Ruby standard library since Ruby 2.0.
