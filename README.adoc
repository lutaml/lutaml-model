...
* Create custom registers for additional data modeling layer (see <<custom-registers>>)
...
Lutaml::Model::Register allows for the creation of custom registers to handle various data modeling layers. 
