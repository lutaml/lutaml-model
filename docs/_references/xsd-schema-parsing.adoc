...
templates (see link:../_guides/liquid-templates.adoc[Liquid Templates]).
These helpers resolve cross-references, flatten nested content models,
and provide sorted access to schema components.
