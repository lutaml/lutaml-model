...
* link:../_references/xsd-type-architecture.adoc[XSD Type Architecture] - Complete architecture reference
* link:../migration-guides/xsd-type-migration.adoc[XSD Type Migration Guide] - Migrating from deprecated patterns
* link:../_guides/schema-generation.adoc[Schema Generation] - Generating XSD schemas
