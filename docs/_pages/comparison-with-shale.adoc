...
A migration guide from Shale to Lutaml::Model is provided at link:../migration-guides/0-1-0-migrate-from-shale.adoc[Migrating from Shale to Lutaml::Model].
...
. Read the link:../migration-guides/0-1-0-migrate-from-shale.adoc[Migration Guide]
