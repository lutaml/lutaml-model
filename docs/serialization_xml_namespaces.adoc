...
XML namespaces provide a way to qualify element and attribute names to avoid conflicts.
Lutaml::Model provides comprehensive namespace support following W3C specifications.
