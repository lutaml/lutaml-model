...
* Inheriting from the [`Lutaml::Model::Serializable`](../lib/lutaml/model/serializable.rb) class
* Including the [`Lutaml::Model::Serialize`](../lib/lutaml/model/serialize.rb) module
...
[`Lutaml::Model::Serializable`](../lib/lutaml/model/serializable.rb).

The [`attribute`](../lib/lutaml/model/attribute.rb) class method is used to define attributes.
...
can be extended using the [`Lutaml::Model::Serialize`](../lib/lutaml/model/serialize.rb) module.
...
* Additional calls to [`attribute`](../lib/lutaml/model/attribute.rb) in the child model are additive, unless the
...
A [`Serialize`](../lib/lutaml/model/serialize.rb) / [`Serializable`](../lib/lutaml/model/serializable.rb) object can be compared with another object of the
same class using the `==` operator. This is implemented through the
[`ComparableModel`](../lib/lutaml/model/comparable_model.rb) module, which provides powerful comparison and diff
functionality.
...
NOTE: Two [`Serialize`](../lib/lutaml/model/serialize.rb) objects will have the same `hash` value if they have the
...
The [`ComparableModel`](../lib/lutaml/model/comparable_model.rb) module provides powerful diff functionality to visualize
...
The [`diff_with_score`](../lib/lutaml/model/comparable_model.rb) method returns **two values** as an array:
