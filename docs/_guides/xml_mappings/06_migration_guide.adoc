...
=== Step 4: Update element declarations and options (optional)
...
xml do
  root 'element', mixed: true, ordered: true
end

# After (recommended syntax)
xml do
  element 'element'
  mixed_content  # Replaces mixed: true
  ordered        # Replaces ordered: true
end
----
