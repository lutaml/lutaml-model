...
* link:../xml/reusable-mapping-classes[Reusable Mapping Classes] - Share mappings across models
...
* link:../native-engines[Native engines (leptris / yeptris)] - Drop-in XML/YAML/JSON engine upgrades via bundle opt-in
