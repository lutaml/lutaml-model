...
cannot be further decomposed. Inherits from [`Lutaml::Model::Type::Value`](../lib/lutaml/model/type/value.rb).

Models::
Defines objects composed of multiple attributes, of which each attribute can be
a type or a model. Inherits from [`Lutaml::Model::Serializable`](../lib/lutaml/model/serializable.rb).

The key differences are described in the table below.

[cols="1,2,2",options="header"]
|===
| Aspect | Types ([`Type::Value`](../lib/lutaml/model/type/value.rb)) | Models ([`Serializable`](../lib/lutaml/model/serializable.rb))
...
h| Inheritance
| `< Lutaml::Model::Type::Value` (or built-in types like [`Type::String`](../lib/lutaml/model/type/string.rb))
| `< Lutaml::Model::Serializable`

h| Registration
| Can be registered as reusable types via [`Lutaml::Model::Type.register`](../lib/lutaml/model/type.rb)
...
from [`Lutaml::Model::Type::Value`](../lib/lutaml/model/type/value.rb) or a class that inherits from it.

A class inheriting from the [`Value`](../lib/lutaml/model/type/value.rb) class carries the attribute `value` which
...
`self.cast(value)`:: Assignment of an external value to the [`Value`](../lib/lutaml/model/type/value.rb) class to be
...
serialization format and returns the object to be assigned to the [`Value`](../lib/lutaml/model/type/value.rb) class'
`value`.
...
from [`Lutaml::Model::Type::DateTime`](../lib/lutaml/model/type/date_time.rb).
...
. Inherit appropriately: Use [`Lutaml::Model::Type::Value`](../lib/lutaml/model/type/value.rb) for completely new
types, or extend built-in types like [`Type::String`](../lib/lutaml/model/type/string.rb), [`Type::Integer`](../lib/lutaml/model/type/integer.rb) for
...
. Register reusable types: Use [`Lutaml::Model::Type.register(:symbol, YourType)`](../lib/lutaml/model/type.rb)
