...
RSpec.describe Lutaml::Xml::Decisions::Decision do
  ...
  describe "#initialize" do
    ...
    it "validates prefix is required for :prefix format" do
      expect do
        described_class.new(format: :prefix, prefix: nil,
                            namespace_class: namespace_class)
      end.to raise_error(ArgumentError, "Prefix required for :prefix format")
    end

    it "validates prefix must be nil for :default format" do
      expect do
        described_class.new(format: :default, prefix: "ex",
                            namespace_class: namespace_class)
