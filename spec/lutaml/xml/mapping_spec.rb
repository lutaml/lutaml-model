...
module XmlMappingSpec
  ...
  class ElementNilNamespaceChild < Lutaml::Model::Serializable
    ...
    xml do
      ...
      namespace :blank # Explicitly in blank namespace
  ...
  shared_examples "having XML Mappings" do |adapter_class|
    ...
    context "with attribute having namespace" do
      ...
      it "checks the attribute with and without namespace" do
        ...
        expected = if adapter_class == Lutaml::Xml::Adapter::OxAdapter
                     <<~XML
    ...
    context "with explicit namespace" do
      ...
      it "nil namespace" do
        ...
        # When parent has element_form_default :qualified (MathMlNamespace has this),
        # children without explicit namespace inherit parent's namespace.
        # No xmlns="" needed because inheritance is automatic.
    ...
    context "with child having explicit namespaces" do
      ...
      it "reads element without namespace" do
        ...
        if adapter_class == Lutaml::Xml::Adapter::NokogiriAdapter
    ...
    context "with schemaLocation" do
      context "when no mixed_content" do
        ...
        it "prints warning if defined explicitly in class" do
          error_regex = /\[Lutaml::Model\] WARN: `schemaLocation` is handled by default\. No need to explicitly define at `mapping_spec.rb:\d+`/
