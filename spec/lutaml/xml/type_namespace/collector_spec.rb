...
RSpec.describe Lutaml::Xml::TypeNamespace::Collector do
  ...
  describe "#collect_from_attribute" do
    ...
    context "when rule has namespace set" do
      ...
      it "returns nil" do
        ref = collector.collect_from_attribute(attribute, rule_with_namespace,
                                               :element)
    ...
    context "when attribute type has no namespace" do
      ...
      it "returns Reference (resolution happens later)" do
        ref = collector.collect_from_attribute(attribute_without_ns, rule,
                                               :element)
  ...
  describe "#resolve_references" do
    ...
    let(:references) do
      [
        ...
        collector.collect_from_attribute(attribute_without_ns, rule2,
                                         :attribute),
      ].compact
    end
