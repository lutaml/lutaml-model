...
RSpec.describe "OrderedContent" do
  ...
  describe Lutaml::Model::Xml::OxAdapter do
    it_behaves_like "ordered content behavior", described_class if TestAdapterConfig.adapter_enabled?(:ox)
  end

  describe Lutaml::Model::Xml::OgaAdapter do
    it_behaves_like "ordered content behavior", described_class if TestAdapterConfig.adapter_enabled?(:oga)
  end
end
