...
#     document_class VobjectDocument
#   end
...
#     def data_to_model(data) # a VObject object
...
#     class Integer < Lutaml::Model::Type::Integer
#     end

#     class Float < Lutaml::Model::Type::Float
#     end
...
#       ),
#       tel: [
#         CustomVojectAdapterSpec::VcardTel.new(number: "tel:+1-555-555-5555"),
#         CustomVojectAdapterSpec::VcardTel.new(number: "tel:+1-555-555-1234"),
#       ],
#       email: ["john.doe@example.com", "j.doe@company.com"],
#       org: "Example Corp",
#       bday: CustomVojectAdapterSpec::VcardBday.new("1970-01-01"),
#     )
#   end
...
#       card = CustomVojectAdapterSpec::Vcard.from_vobject(vobject_data).first
...
#       card = CustomVojectAdapterSpec::Vcard.from_vobject(iso_date_time_vcard).first
...
#       card = CustomVojectAdapterSpec::Vcard.from_vobject(iso_date_vcard).first
#       expect(card.bday.value.to_s).to eq("19850412")
#       expect(card.bday.type).to eq(:date)
#     end

#     it "parses text BDAY correctly" do
#       card = CustomVojectAdapterSpec::Vcard.from_vobject(text_date_vcard).first
...
# RSpec.describe CustomVojectAdapterSpec::VobjectPropertyValue do
#   describe ".parse" do
...
# RSpec.describe CustomVojectAdapterSpec::VobjectValueType::Base do
