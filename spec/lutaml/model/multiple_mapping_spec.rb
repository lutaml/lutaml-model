...
RSpec.describe "Multiple Mapping Support" do
  ...
  context "with XML format" do
    shared_examples "xml adapter with multiple mappings" do |adapter_class|
      ...
      it "handles bidirectional conversion with attributes and content" do
        ...
        expect(product1.to_xml).to be_equivalent_to(expected_xml_product_1)
        expect(product2.to_xml).to be_equivalent_to(expected_xml_product_2)
      end
    end
