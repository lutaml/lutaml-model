...
RSpec.xdescribe MapContent do
  ...
  let(:bold_text) { MapContent::Bold.new(text: "bold text", italic: italic_text) }
  let(:rich_text) { MapContent::RichText.new(text: "regular text", bold: bold_text, italic: italic_text) }
  ...
  it "round-trips XML" do
    ...
    expect(new_model.description.bold.italic.text).to eq(model.description.bold.italic.text)
    expect(new_model.description.italic.text).to eq(model.description.italic.text)
