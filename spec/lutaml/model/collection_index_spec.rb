...
RSpec.describe "Collection index_by" do
  describe "single index" do
    ...
    describe "#index_caches" do
      it "returns the built index cache" do
        ...
        expect(collection.index_caches[:id].keys).to contain_exactly("001",
                                                                     "002", "003")
      end
    end
    ...
    describe "index updates on mutation" do
      it "rebuilds index after #push" do
        collection.push(CollectionIndexTests::Person.new(id: "004",
                                                         name: "Diana"))
      ...
      it "rebuilds index after #[]=" do
        collection[0] =
          CollectionIndexTests::Person.new(id: "006", name: "Frank")
  ...
  describe "multiple indexes" do
    ...
    describe "#index_caches" do
      it "builds separate caches for each index" do
        expect(collection.index_caches.keys).to contain_exactly(:id, :email,
                                                                :slug)
      end
    end
  end
  ...
  describe "inheritance" do
    ...
    let(:collection) do
      child_class.new([{ id: "001", name: "Alice",
    ...
    it "parent class retains its indexes" do
      parent_collection = parent_class.new([{ id: "001", name: "Alice",
                                              email: "alice@example.com" }])
