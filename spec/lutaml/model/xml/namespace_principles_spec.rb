    ...
    context "inherited items in collections" do
      let(:instance) do
        NamespacePrinciplesSpec::InheritedCollection.new(items: [
                                                           NamespacePrinciplesSpec::InheritedNativeItem.new(name: "Item Name",
    ...
    context "Polymorphic Collection with items in collection namespace" do
      let(:collection) do
        NamespacePrinciplesSpec::PolyCollection.new([
                                                      NamespacePrinciplesSpec::FirstTypeItem.new(type: "first",
                                                                                                 first_value: "First Value"),
                                                      NamespacePrinciplesSpec::SecondTypeItem.new(type: "second",
    ...
    context "Polymorphic Collection with items in different namespaces" do
      let(:collection) do
        NamespacePrinciplesSpec::PolyCollectionMixed.new([
                                                           NamespacePrinciplesSpec::FirstTypeItemInDifferentNamespace.new(
                                                             type: "first", first_value: "First Value",
                                                           ),
                                                           NamespacePrinciplesSpec::SecondTypeItemInDifferentNamespace.new(
                                                             type: "second", second_value: "Second Value",
                                                           ),
                                                         ])
      end
