...
RSpec.describe "Type Namespace Prefix Issue #6" do
  ...
  context "edge cases" do
    it "handles type namespace when element has explicit namespace override" do
      ...
      # Create child model with explicit namespace
      content_class = Class.new(Lutaml::Model::Serializable) do
      ...
      instance = test_class.new(content: content_class.new(value: "test"))
      xml_output = instance.to_xml
