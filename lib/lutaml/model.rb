...
module Lutaml
  module Model
    ...
    autoload :RuleValueExtractor, "#{__dir__}/model/services/rule_value_extractor"
    ...
    autoload :InvalidAttributeTypeError, "#{__dir__}/model/error/invalid_attribute_type_error"
    autoload :LiquidNotEnabledError, "#{__dir__}/model/error/liquid_not_enabled_error"
    autoload :LiquidClassNotFoundError, "#{__dir__}/model/error/liquid_class_not_found_error"
    autoload :NoAttributesDefinedLiquidError, "#{__dir__}/model/error/no_attributes_defined_liquid_error"
    autoload :IncorrectMappingArgumentsError, "#{__dir__}/model/error/incorrect_mapping_argument_error"
    autoload :PatternNotMatchedError, "#{__dir__}/model/error/pattern_not_matched_error"
    autoload :UnknownAdapterTypeError, "#{__dir__}/model/error/unknown_adapter_type_error"
    autoload :FormatAdapterNotSpecifiedError, "#{__dir__}/model/error/format_adapter_not_specified_error"
    autoload :CollectionCountOutOfRangeError, "#{__dir__}/model/error/collection_count_out_of_range_error"
    autoload :ElementCountOutOfRangeError, "#{__dir__}/model/error/element_count_out_of_range_error"
    autoload :ValidationError, "#{__dir__}/model/error/validation_error"
    autoload :TypeNotEnabledError, "#{__dir__}/model/error/type_not_enabled_error"
    autoload :TypeError, "#{__dir__}/model/error/type_error"
    autoload :UnknownTypeError, "#{__dir__}/model/error/unknown_type_error"
    autoload :RequiredAttributeMissingError, "#{__dir__}/model/error/required_attribute_missing_error"
    autoload :MultipleMappingsError, "#{__dir__}/model/error/multiple_mappings_error"
    autoload :CollectionTrueMissingError, "#{__dir__}/model/error/collection_true_missing_error"
    autoload :IncorrectSequenceError, "#{__dir__}/model/error/incorrect_sequence_error"
    autoload :ChoiceUpperBoundError, "#{__dir__}/model/error/choice_upper_bound_error"
    autoload :NoRootMappingError, "#{__dir__}/model/error/no_root_mapping_error"
    autoload :ImportModelWithRootError, "#{__dir__}/model/error/import_model_with_root_error"
    autoload :InvalidChoiceRangeError, "#{__dir__}/model/error/invalid_choice_range_error"
    autoload :UnknownSequenceMappingError, "#{__dir__}/model/error/unknown_sequence_mapping_error"
    autoload :ChoiceLowerBoundError, "#{__dir__}/model/error/choice_lower_bound_error"
    autoload :NoMappingFoundError, "#{__dir__}/model/error/no_mapping_found_error"
    autoload :NoRootNamespaceError, "#{__dir__}/model/error/no_root_namespace_error"
    autoload :PolymorphicError, "#{__dir__}/model/error/polymorphic_error"
    autoload :ValidationFailedError, "#{__dir__}/model/error/validation_failed_error"
    autoload :InvalidAttributeNameError, "#{__dir__}/model/error/invalid_attribute_name_error"
    autoload :InvalidAttributeOptionsError, "#{__dir__}/model/error/invalid_attribute_options_error"
    autoload :UndefinedAttributeError, "#{__dir__}/model/error/undefined_attribute_error"
    autoload :SortingConfigurationConflictError, "#{__dir__}/model/error/sorting_configuration_conflict_error"
    autoload :TransformBlockNotDefinedError, "#{__dir__}/model/error/transform_block_not_defined_error"
    autoload :ReverseTransformBlockNotDefinedError, "#{__dir__}/model/error/reverse_transform_block_not_defined_error"
    autoload :MappingAttributeMissingError, "#{__dir__}/model/error/mapping_attribute_missing_error"
    autoload :MappingAttributeTypeError, "#{__dir__}/model/error/mapping_attribute_type_error"
    autoload :MappingAlreadyExistsError, "#{__dir__}/model/error/mapping_already_exists_error"
    autoload :ReverseTransformationDeclarationError, "#{__dir__}/model/error/reverse_transformation_declaration_error"
    autoload :UnresolvableTypeError, "#{__dir__}/model/error/unresolvable_type_error"
