    ...
    module Xml
      class MappingRule < MappingRule
        ...
        def normalize_namespace(namespace)
          ...
          if namespace.is_a?(Class) && namespace < Lutaml::Model::Xml::Namespace
        ...
        def resolve_attribute_namespace(attr, register, parent_ns_class = nil,
form_default = :unqualified)
        ...
        def build_namespace_result_from_class(ns_class)
          # Guard against :blank symbol (blank namespace has no URI)
          return { uri: nil, prefix: nil, ns_class: nil } if ns_class == :blank
