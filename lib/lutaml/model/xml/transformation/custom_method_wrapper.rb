    ...
    module Xml
      ...
      class CustomMethodWrapper
        ...
        def add_nokogiri_children_to_parent(nokogiri_node, parent)
          nokogiri_node.children.each do |child|
            ...
            when ::Nokogiri::XML::Element
              ...
              element = Lutaml::Model::XmlDataModel::XmlElement.new(child.name)
              ...
              child.attributes.each_value do |attr|
                xml_attr = Lutaml::Model::XmlDataModel::XmlAttribute.new(
        ...
        def add_attribute(element, name, value)
          attr = Lutaml::Model::XmlDataModel::XmlAttribute.new(name.to_s,
                                                               value.to_s)
        ...
        def create_and_add_element(name, attributes: {})
          ...
          attributes&.each do |attr_name, attr_value|
            attr = Lutaml::Model::XmlDataModel::XmlAttribute.new(
        ...
        class ElementWrapper
          ...
          def create_and_add_element(name, attributes: {})
            # Create XmlDataModel element
            child = Lutaml::Model::XmlDataModel::XmlElement.new(name)
