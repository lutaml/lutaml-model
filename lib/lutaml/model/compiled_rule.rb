...
module Lutaml
  module Model
    ...
    class CompiledRule
      ...
      # @return [Array<String>, nil] Alias names for multiple mappings
      ...
      # @param alias_names [Array<String>, nil] Alias names for multiple mappings
      ...
      # @return [Boolean] true if the name matches serialized_name or any alias
